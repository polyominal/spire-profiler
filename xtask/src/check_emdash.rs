...
const PINS: &[(&str, usize)] = &[
    ...
    ("profiler-core/src/data/ledger.rs", 5),
    ("profiler-core/src/data/persistence.rs", 6),
    ("profiler-core/src/data/persistence/combats.rs", 2),
    ("profiler-core/src/data/persistence/time.rs", 1),
    ("profiler-core/src/data/run_history.rs", 10),
    ...
    ("profiler-core/src/ui/theme.rs", 8),
