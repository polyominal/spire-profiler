...
internal abstract class AttributionBackend
{
    ...
    internal virtual int CalculateModifierCredit(decimal basis, decimal value, int kind, decimal limit)
        => ProfilerNative.CalculateModifierCredit(basis, value, kind, limit);
